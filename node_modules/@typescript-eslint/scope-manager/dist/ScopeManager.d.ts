...
import type { Scope } from '.js';
import type { Variable } from '.js';
import { BlockScope, CatchScope, ClassScope, ConditionalTypeScope, ForScope, FunctionExpressionNameScope, FunctionScope, FunctionTypeScope, GlobalScope, MappedTypeScope, ModuleScope, SwitchScope, TSEnumScope, TSModuleScope, TypeScope, WithScope } from '.js';
import { ClassFieldInitializerScope } from '.js';
import { ClassStaticBlockScope } from '.js';
